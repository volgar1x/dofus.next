...
/***/ function(module, exports, __webpack_require__) {
	...
	var _usersForm = __webpack_require__(/*! ./users/form */ 157);
	...
	var _navbar = __webpack_require__(/*! ./navbar */ 162);
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        'div',
	                        { className: 'row' },
	                        _react2['default'].createElement(_usersForm2['default'], null)
	                    )
	                )
	            );
	        }
	...
	_react2['default'].render(_react2['default'].createElement(Component, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _formsValidate = __webpack_require__(/*! ../forms/validate */ 160);
	
	var _formsValidate2 = _interopRequireDefault(_formsValidate);
	    ...
	    _createClass(Form, [{
	        ...
	        value: function render() {
	            return _reactAddons2['default'].createElement(
	                ...
	                _reactAddons2['default'].addons.cloneWithProps(this.props.children)
	            );
	        }
	    }, {
	        key: 'onSubmit',
	        value: function onSubmit(e) {
	            ...
	            var errors = _formsValidate2['default'].data(this.props.validate);
	        ...
	        value: { errors: _reactAddons2['default'].PropTypes.any },
	        enumerable: true
	    }]);
	...
	var InputWidget = (function (_React$Component2) {
	    ...
	    _inherits(InputWidget, _React$Component2);
	
	    _createClass(InputWidget, [{
	        key: 'render',
	        value: function render() {
	            var className = (0, _classnames2['default'])('form-control', this.props.className);
	
	            return _reactAddons2['default'].createElement('input', { type: this.props.type,
	...
	var EmailWidget = (function (_React$Component3) {
	    function EmailWidget() {
	        _classCallCheck(this, EmailWidget);
	    ...
	    _inherits(EmailWidget, _React$Component3);
	
	    _createClass(EmailWidget, [{
	        key: 'render',
	        value: function render() {
	            var className = (0, _classnames2['default'])('form-control', this.props.className);
	            ...
	            return _reactAddons2['default'].createElement(
	                ...
	                _reactAddons2['default'].createElement('input', { type: this.props.type,
	                    label: this.props.label,
	                    placeholder: this.props.placeholder,
	                    id: this.props.name,
	                    className: className,
	    ...
	    _createClass(Field, [{
	        ...
	        value: function render() {
	            ...
	            if ('email' === this.props.type) {
	                widget = _reactAddons2['default'].createElement(EmailWidget, { name: this.props.name });
	            } else {
	                widget = _reactAddons2['default'].createElement(InputWidget, { type: this.props.type, name: this.props.name });
	            }
	
	            var errors = this.context.errors.get(this.props.name, false);
	
	            var helpBlocks = errors && errors.map(function (err) {
	                return _reactAddons2['default'].createElement(
	                    'span',
	            ...
	            var classNames = (0, _classnames2['default'])('form-group', {
	...
	var SubmitAction = (function (_React$Component6) {
	    function SubmitAction() {
	        _classCallCheck(this, SubmitAction);
	    ...
	    _inherits(SubmitAction, _React$Component6);
	
	    _createClass(SubmitAction, [{
	        key: 'render',
	        value: function render() {
	            return _reactAddons2['default'].createElement('input', { type: 'submit', className: 'btn btn-primary', value: this.props.label });
	        }
	    }]);
	...
	var UserForm = (function (_React$Component7) {
	    function UserForm() {
	    ...
	    _inherits(UserForm, _React$Component7);
	    ...
	    _createClass(UserForm, [{
	        ...
	        value: function render() {
	            return _reactAddons2['default'].createElement(
	                Form,
	                { onSubmit: this.onSubmit.bind(this), validate: UserForm.validations },
	                _reactAddons2['default'].createElement(Field, { type: 'email', label: 'Your Email', name: 'email' }),
	                _reactAddons2['default'].createElement(Field, { type: 'text', label: 'Account Name', name: 'name' }),
	                _reactAddons2['default'].createElement(Field, { type: 'password', label: 'Password', name: 'pass1' }),
	                _reactAddons2['default'].createElement(Field, { type: 'password', label: 'Password (confirmation)', name: 'pass2' }),
	                _reactAddons2['default'].createElement(Field, { type: 'text', label: 'Your Nickname', name: 'nick' }),
	                _reactAddons2['default'].createElement(Field, { type: 'text', label: 'Secret Question', name: 'question' }),
	                _reactAddons2['default'].createElement(
	                    Actions,
	                    null,
	                    _reactAddons2['default'].createElement(SubmitAction, { label: 'Create Account' })
	                )
	            );
	        }
	    }, {
	        ...
	        key: 'validations',
	        value: (0, _immutable.List)([_formsValidate2['default'].presence('email'), _formsValidate2['default'].presence('name'), _formsValidate2['default'].presence('pass1'), _formsValidate2['default'].presence('pass2'), _formsValidate2['default'].presence('nick'), _formsValidate2['default'].presence('question'), _formsValidate2['default'].same('pass1', 'pass2')]),
	        enumerable: true
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function validate(data, validator) {
	    return validator.flatten().reduce(function (acc, validator) {
	        return validator(data, acc);
	    }, (0, _immutable.Map)());
	}
	...
	validate.same = function (field1, field2) {
	    return function (data, err) {
	        if (data[field1] !== field[field2]) {
	            return err.set(field1, "Must equal " + field2).set(field2, "Must equal " + field1);
	        }
	        return err;
	    };
	};
	        ...
	        value: function render() {
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    "p",
	                    null,
	                    "Not the emulator we need, but the emulator we deserve."
	                )
	            );
	        }
	    }]);
